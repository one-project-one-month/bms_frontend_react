...
const TransferPage = () => {
    ...
    const headers = {
        ...
        'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhZG1pbkNvZGUiOiJibXNfMWFkNGI2N2UyYjVhN2JlNjA5MTJhYTJkNDc0ZDQxMGEiLCJyb2xlIjoiQWRtaW4iLCJpYXQiOjE3MTc1MjQ0NzUsImV4cCI6MTcxNzYxMDg3NX0.DYxE513YBnj24Z828Z6dMNEzwD1Eoti5yk54lDf41jQ'
    };
    ...
    return (
        <div className="w-full mx-auto h-screen">
            <div className={`w-full max-w-lg ${success || errorMessage?.message ? 'mx-auto mt-20' : 'ml-4 mt-8'}`}>
